  ...
  return (
    <div className="space-y-2">
      <div className="space-y-1.5">
        <Label htmlFor="note" className="text-xs">Your feedback (optional)</Label>
        <Textarea id="note" value={note} onChange={(e) => setNote(e.target.value)} rows={2} placeholder="Add a comment for the team…" />
      </div>
