...
import { Users, Tags, FileText, Palette, Plug, ArrowDownUp, Shield, Settings as SettingsIcon } from "lucide-react";

const NAV = [
  { href: "/settings/general", label: "General", icon: SettingsIcon, perm: "settings.read" as const },
  ...
  { href: "/settings/roles", label: "Roles & permissions", icon: Shield, perm: "roles.read" as const },
  { href: "/settings/customization", label: "Customization", icon: Palette, perm: "settings.read" as const },
  { href: "/settings/audit", label: "Audit log", icon: FileText, perm: "audit.read" as const },
  { href: "/settings/integrations", label: "Integrations", icon: Plug, perm: "integrations.read" as const },
  { href: "/settings/import-export", label: "Import / Export", icon: ArrowDownUp, perm: "settings.read" as const },
];
