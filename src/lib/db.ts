...
type QueryArgs = { where?: JsonRecord; data?: unknown; include?: JsonRecord; select?: JsonRecord; orderBy?: unknown; take?: number; skip?: number }
...
type Relation = { model: string; foreignKey?: string; targetForeignKey?: string; junction?: { model: string; sourceKey: string; targetKey: string } }
const RELATIONS: Record<string, Record<string, Relation>> = {
  workspaceMembership: { workspace: { model: "workspace", foreignKey: "workspaceId" }, user: { model: "user", foreignKey: "userId" }, roles: { model: "role", junction: { model: "membershipRole", sourceKey: "membershipId", targetKey: "roleId" } } },
  membershipRole: { role: { model: "role", foreignKey: "roleId" }, membership: { model: "workspaceMembership", foreignKey: "membershipId" } },
  role: { permissions: { model: "permission", junction: { model: "rolePermission", sourceKey: "roleId", targetKey: "permissionId" } }, memberships: { model: "workspaceMembership", junction: { model: "membershipRole", sourceKey: "roleId", targetKey: "membershipId" } } },
  rolePermission: { role: { model: "role", foreignKey: "roleId" }, permission: { model: "permission", foreignKey: "permissionId" } },
  invitation: { workspace: { model: "workspace", foreignKey: "workspaceId" }, roles: { model: "role", junction: { model: "invitationRole", sourceKey: "invitationId", targetKey: "roleId" } } },
  invitationRole: { role: { model: "role", foreignKey: "roleId" }, invitation: { model: "invitation", foreignKey: "invitationId" } },
  ...
  company: { owner: { model: "user", foreignKey: "ownerId" }, contacts: { model: "contact", targetForeignKey: "companyId" }, deals: { model: "deal", targetForeignKey: "companyId" } },
  contact: { company: { model: "company", foreignKey: "companyId" }, owner: { model: "user", foreignKey: "ownerId" }, clientContacts: { model: "clientContact", targetForeignKey: "contactId" } },
  lead: { contact: { model: "contact", foreignKey: "contactId" }, company: { model: "company", foreignKey: "companyId" }, owner: { model: "user", foreignKey: "ownerId" } },
  deal: { stage: { model: "pipelineStage", foreignKey: "stageId" }, company: { model: "company", foreignKey: "companyId" }, primaryContact: { model: "contact", foreignKey: "primaryContactId" }, owner: { model: "user", foreignKey: "ownerId" } },
  activity: { owner: { model: "user", foreignKey: "ownerId" }, contact: { model: "contact", foreignKey: "contactId" }, deal: { model: "deal", foreignKey: "dealId" } },
  note: { owner: { model: "user", foreignKey: "ownerId" } },
  client: { owner: { model: "user", foreignKey: "ownerId" }, projects: { model: "project", targetForeignKey: "clientId" }, clientRequests: { model: "clientRequest", targetForeignKey: "clientId" }, retainers: { model: "retainer", targetForeignKey: "clientId" }, invoices: { model: "invoice", targetForeignKey: "clientId" }, expenses: { model: "expense", targetForeignKey: "clientId" }, clientContacts: { model: "clientContact", targetForeignKey: "clientId" } },
  clientContact: { client: { model: "client", foreignKey: "clientId" }, contact: { model: "contact", foreignKey: "contactId" } },
  clientRequest: { client: { model: "client", foreignKey: "clientId" }, workspace: { model: "workspace", foreignKey: "workspaceId" } },
  project: { client: { model: "client", foreignKey: "clientId" }, status: { model: "projectStatus", foreignKey: "statusId" }, owner: { model: "user", foreignKey: "ownerId" }, tasks: { model: "task", targetForeignKey: "projectId" }, milestones: { model: "milestone", targetForeignKey: "projectId" }, timeEntries: { model: "timeEntry", targetForeignKey: "projectId" }, deliverables: { model: "deliverable", targetForeignKey: "projectId" }, campaigns: { model: "campaign", targetForeignKey: "projectId" }, members: { model: "projectMember", targetForeignKey: "projectId" } },
  projectMember: { membership: { model: "workspaceMembership", foreignKey: "membershipId" }, project: { model: "project", foreignKey: "projectId" } },
  task: { project: { model: "project", foreignKey: "projectId" }, status: { model: "taskStatus", foreignKey: "statusId" }, assignee: { model: "user", foreignKey: "assigneeId" }, owner: { model: "user", foreignKey: "ownerId" }, milestone: { model: "milestone", foreignKey: "milestoneId" } },
  milestone: { project: { model: "project", foreignKey: "projectId" }, tasks: { model: "task", targetForeignKey: "milestoneId" } },
  approvalRequest: { steps: { model: "approvalStep", targetForeignKey: "approvalRequestId" }, events: { model: "approvalEvent", targetForeignKey: "approvalRequestId" }, client: { model: "client", foreignKey: "clientId" } },
  approvalStep: { approvalRequest: { model: "approvalRequest", foreignKey: "approvalRequestId" }, user: { model: "user", foreignKey: "approverId" } },
  approvalEvent: { approvalRequest: { model: "approvalRequest", foreignKey: "approvalRequestId" }, actorUser: { model: "user", foreignKey: "actorUserId" } },
  timeEntry: { user: { model: "user", foreignKey: "userId" }, project: { model: "project", foreignKey: "projectId" }, client: { model: "client", foreignKey: "clientId" } },
  invoice: { client: { model: "client", foreignKey: "clientId" }, lines: { model: "invoiceLine", targetForeignKey: "invoiceId" } },
  invoiceLine: { invoice: { model: "invoice", foreignKey: "invoiceId" }, project: { model: "project", foreignKey: "projectId" } },
  expense: { client: { model: "client", foreignKey: "clientId" }, project: { model: "project", foreignKey: "projectId" } },
  clientPortal: { client: { model: "client", foreignKey: "clientId" }, contact: { model: "contact", foreignKey: "contactId" }, workspace: { model: "workspace", foreignKey: "workspaceId" } },
  fileRecord: { owner: { model: "user", foreignKey: "ownerId" }, versions: { model: "deliverableVersion", targetForeignKey: "fileId" }, client: { model: "client", foreignKey: "clientId" } },
  deliverable: { owner: { model: "user", foreignKey: "ownerId" }, project: { model: "project", foreignKey: "projectId" }, versions: { model: "deliverableVersion", targetForeignKey: "deliverableId" } },
  deliverableVersion: { owner: { model: "user", foreignKey: "ownerId" }, deliverable: { model: "deliverable", foreignKey: "deliverableId" } },
  campaign: { owner: { model: "user", foreignKey: "ownerId" }, project: { model: "project", foreignKey: "projectId" } },
  notification: { user: { model: "user", foreignKey: "userId" }, actorUser: { model: "user", foreignKey: "actorUserId" } },
...
const FIELD_ALIASES: Record<string, Record<string, string>> = {
  ...
  client: { ownerId: "owner_user_id" }, project: { ownerId: "owner_user_id" }, task: { ownerId: "owner_user_id", assigneeId: "assignee_user_id" },
  campaign: { ownerId: "owner_user_id" }, deliverable: { ownerId: "owner_user_id" }, contentItem: { ownerId: "owner_user_id" },
  comment: { authorId: "author_user_id" }, activityEvent: { actorUserId: "actor_user_id" }, notification: { userId: "user_id", actorUserId: "actor_user_id" },
  fileRecord: { uploaderId: "uploader_user_id" }, approvalRequest: { requestedById: "requested_by" }, approvalStep: { decidedById: "decided_by_user_id" },
...
async function hydrate(model: string, row: JsonRecord, specification: JsonRecord | undefined): Promise<JsonRecord> {
  ...
  for (const [name, requested] of Object.entries(specification)) {
    if (name === "_count") {
      ...
      for (const [countName, enabled] of Object.entries((requested as JsonRecord).select ?? {})) {
        ...
        if (enabled && relation?.targetForeignKey) {
          const records = await run(relation.model, "findMany", { where: { [relation.targetForeignKey]: row.id } })
    ...
    if (relation.junction) {
      const links = await run(relation.junction.model, "findMany", { where: { [relation.junction.sourceKey]: row.id } }) as JsonRecord[]
      const ids = links.map((link) => link[relation.junction!.targetKey]).filter(Boolean)
      row[name] = []
      for (const id of ids) {
        const target = await run(relation.model, "findFirst", { where: { id }, include: nested.include as JsonRecord | undefined, select: nested.select as JsonRecord | undefined })
    ...
    if (relation.foreignKey) {
      ...
      row[name] = foreignId ? await run(relation.model, "findFirst", { where: { id: foreignId }, include: nested.include as JsonRecord | undefined, select: nested.select as JsonRecord | undefined }) : null
    } else if (relation.targetForeignKey) {
      row[name] = await run(relation.model, "findMany", { where: { [relation.targetForeignKey]: row.id }, include: nested.include as JsonRecord | undefined, select: nested.select as JsonRecord | undefined, orderBy: nested.orderBy, take: typeof nested.take === "number" ? nested.take : undefined })
    }
  }
  return row
}
...
async function run(model: string, operation: string, args: QueryArgs = {}): Promise<unknown> {
  ...
  const tableClient: any = client.schema(table.includes(".") ? table.split(".")[0] : "public").from(table.includes(".") ? table.split(".")[1] : table)
  const where = uniqueWhere(args.where)
  let query: any
  if (operation === "create" || operation === "createMany") {
    const payload = operation === "createMany" ? (args.data as unknown[]).map((item) => toSql(model, item)) : toSql(model, args.data)
  ...
  if (operation === "upsert") {
    ...
    const result = await tableClient.upsert(toSql(model, args.data), { onConflict: conflict }).select("*")
    if (result.error) throw result.error
    return toModel(model, result.data?.[0] ?? null)
  }
  ...
  for (const raw of result.data ?? []) hydratedRows.push(await hydrate(model, toModel(model, raw) as JsonRecord, args.include))
